...
class EventsAPI:
    ...
    def add_item_to_cart(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$add_item_to_cart", add_item_to_cart_properties
        )

    def add_promotion(self) -> sift.client.Response:
    ...
    def chargeback(self) -> sift.client.Response:
    ...
    def content_status(self) -> sift.client.Response:
    ...
    def create_account(self) -> sift.client.Response:
    ...
    def create_content_comment(self) -> sift.client.Response:
    ...
    def create_content_listing(self) -> sift.client.Response:
    ...
    def create_content_message(self) -> sift.client.Response:
    ...
    def create_content_post(self) -> sift.client.Response:
    ...
    def create_content_profile(self) -> sift.client.Response:
    ...
    def create_content_review(self) -> sift.client.Response:
        # Sample $create_content event for reviews
        review_properties = {
            # Required fields
            "$user_id": self.user_id,
    ...
    def create_order(self) -> sift.client.Response:
    ...
    def create_order_with_warnings(self) -> sift.client.Response:
        # Sample $create_order event
        order_properties = self.build_create_order_event()
        return self.client.track(
            "$create_order", order_properties, include_warnings=True
        )

    def build_create_order_event(self) -> dict[str, t.Any]:
        order_properties = {
            # Required Fields
            "$user_id": self.user_id,
            # Supported Fields
    ...
    def flag_content(self) -> sift.client.Response:
    ...
    def link_session_to_user(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$link_session_to_user", link_session_to_user_properties
        )

    def login(self) -> sift.client.Response:
        # Sample $login event
        login_properties = {
            # Required Fields
            "$user_id": self.user_id,
    ...
    def logout(self) -> sift.client.Response:
        # Sample $logout event
        logout_properties = {
            # Required Fields
            "$user_id": self.user_id,
    ...
    def order_status(self) -> sift.client.Response:
    ...
    def remove_item_from_cart(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$remove_item_from_cart", remove_item_from_cart_properties
        )

    def security_notification(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$security_notification", security_notification_properties
        )

    def transaction(self) -> sift.client.Response:
    ...
    def update_account(self) -> sift.client.Response:
    ...
    def update_content_comment(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$update_content", update_content_comment_properties
        )

    def update_content_listing(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$update_content", update_content_listing_properties
        )

    def update_content_message(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$update_content", update_content_message_properties
        )

    def update_content_post(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$update_content", update_content_post_properties
        )

    def update_content_profile(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$update_content", update_content_profile_properties
        )

    def update_content_review(self) -> sift.client.Response:
        # Sample $update_content event for reviews
        ...
        return self.client.track(
            "$update_content", update_content_review_properties
        )

    def update_order(self) -> sift.client.Response:
    ...
    def update_password(self) -> sift.client.Response:
        ...
        return self.client.track(
            "$update_password", update_password_properties
        )

    def verification(self) -> sift.client.Response:
