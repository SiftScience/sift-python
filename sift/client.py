...
class Client(object):
    ...
    def score(self, user_id, timeout=None):
        ...
        This call is blocking.  Check out
        https://siftscience.com/resources/references/score_api.html for more information on our
    ...
    def label(self, user_id, properties, timeout=None):
        ...
        This call is blocking.  Check out
        https://siftscience.com/resources/references/labels_api.html for more information on what
        fields to send in properties.
    ...
    def unlabel(self, user_id, timeout=None):
        ...
        This call is blocking.  Check out
        https://siftscience.com/resources/references/labels_api.html for more information.
